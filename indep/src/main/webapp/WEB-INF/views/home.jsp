...
<section id="work" class="main style3 primary">
    <div class="content">
        ...
        <article class="from-left">
            <a href="./images/fulls/11.png" class="image fit"><img src="./images/thumbs/11.png" title="Tu informacion en la nube" alt="" /></a>
        </article>
        <article class="from-right">
            <a href="./images/fulls/12.jpg" class="image fit"><img src="./images/thumbs/12.jpg" title="Posicion actualizada" alt="" /></a>
        </article>
        <article class="from-left">
            <a href="./images/fulls/13.jpg" class="image fit"><img src="./images/thumbs/13.jpg" title="Modulo de gastos" alt="" /></a>
        </article>
        <article class="from-right">
            <a href="./images/fulls/14.jpg" class="image fit"><img src="./images/thumbs/14.jpg" title="Modulo de Ingresos" alt="" /></a>
        </article>
        <article class="from-left">
            <a href="./images/fulls/15.jpg" class="image fit"><img src="./images/thumbs/15.jpg" title="Mejora tus inversiones" alt="" /></a>
        </article>
        <article class="from-right">
            <a href="./images/fulls/16.jpg" class="image fit"><img src="./images/thumbs/16.jpg" title="Servicio Premium" alt="" /></a>
        </article>
    </div>
